defmodule AnovavozNative do
  ...
  import AnovavozWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {AnovavozWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([AnovavozWeb, CoreComponents, plugin.module_suffix])
