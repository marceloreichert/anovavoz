defmodule AnovavozWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `AnovavozWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AnovavozWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AnovavozWeb.Gettext, "errors", msg, opts)
    end
  end
