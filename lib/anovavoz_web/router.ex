defmodule AnovavozWeb.Router do
  use AnovavozWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout,
      html: {AnovavozWeb.Layouts, :root},
      swiftui: {AnovavozWeb.Layouts.SwiftUI, :root}
  ...
  scope "/", AnovavozWeb do
    pipe_through :browser

    live "/", HomeLive

    scope "/recipes" do
      live "/br-senator", BrSenatorLive,
        metadata: %{
  ...
  # scope "/api", AnovavozWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:anovavoz, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: AnovavozWeb.Telemetry
